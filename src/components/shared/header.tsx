      ...
      <div className="flex h-14 items-center justify-between px-4 max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-2">
          {currentView === 'landing' || currentView === 'dashboard' ? (
            ...
            >
              <TrendingUp className="h-6 w-6 text-neon-cyan group-hover:drop-shadow-[0_0_8px_rgba(0,255,242,0.6)] transition-all duration-300" strokeWidth={2.5} />
              <span className="text-base font-bold whitespace-nowrap bg-gradient-to-r from-neon-cyan to-neon-purple bg-clip-text text-transparent">
                B2B Market Grid
              </span>
            </button>
          ) : (
