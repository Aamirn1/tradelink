...
export function LandingPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        'Every wholesaler on B2B Market Grid goes through verification. Quality profiles you can trust for reliable partnerships.',
      glow: 'neon-glow-purple',
      border: 'neon-border-purple',
      iconColor: 'text-neon-purple',
      bgAccent: 'from-neon-purple/10 to-transparent',
      ...
      <div className="container mx-auto px-4 relative z-10">
        <AnimatedSection className="text-center mb-16">
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-medium glass neon-border-purple text-neon-purple mb-4">
            <Zap className="h-3.5 w-3.5" /> Why B2B Market Grid
          </span>
